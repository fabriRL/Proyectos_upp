...
// "Días de atraso" no se escribe a mano — se calcula solo, con la misma
// fórmula que "Días de Demora" (Desembolso − Aprobación Fiscal). Es
// puramente informativo: ya NO tiene ninguna relación con la multa, que
// ahora es 100% manual (ver campo "Multa" abajo).
...
function resetForm() {
  Object.assign(form, {
    ...
    monto_certificado: null, retencion_gcc: 0, multa: 0,
    importe_pagado_sigep: null, numero_c31: '', monto_c31: null,
  })
  errors.value = {}
  errorPaso.value = ''
  currentStep.value = 1
...
async function guardar() {
  ...
  try {
    ...
    // "dias_atraso" NO se manda — el backend lo recalcula solo, a partir
    // de fecha_aprobacion_fiscal y fecha_desembolso.
            ...
            <form @submit.prevent="onSubmit">
              ...
              <div v-show="currentStep === 1" :style="sGrid">
                ...
                <div :style="sField">
                  ...
                  />
                  <div :style="sHint">
                    Desembolso − Aprobación Fiscal. Solo informativo — no afecta la multa. Sale en 0 hasta que registres la fecha de desembolso.
                  </div>
                </div>
              </div>
              ...
              <div v-show="currentStep === 2" :style="sGrid">
                ...
                <div :style="sField">
                  ...
                  <div :style="sHint">Opcional — monto a criterio del usuario, sin cálculo automático.</div>
                  <span :style="sError" v-if="errors.multa">{{ errors.multa[0] }}</span>
                </div>
                <div :style="sField">
                  <div :style="sHint" style="margin-top:24px;">La amortización de anticipo y el líquido pagable se calculan automáticamente.</div>
                </div>
              ...
              <div :style="sActions">
                ...
                <button type="submit" :style="sBtnSave" :disabled="enviando">
                  ...
                  <span v-else>{{ enviando ? 'Guardando...' : 'Guardar planilla' }}</span>
                </button>
              </div>
            </form>
          </div>
