...
const average = computed(() => {
  ...
  const val = indicators.value.reduce((sum, item) => sum + item.value, 0) / indicators.value.length
...
function exportarCsv() {
  ...
  // \uFEFF al inicio para que Excel detecte UTF-8 y no rompa las tildes/ñ
      ...
      <section class="indicator-panel">
        ...
        <div class="indicator-grid">
          ...
          >
            ...
            <div class="bar"><span :style="{ width: `${indicator.value}%` }"></span></div>
