...
// Guarda el nuevo Decreto Supremo AL INSTANTE en el catálogo (no espera
// al submit final del proyecto) — así queda confirmado, reutilizable para
// otros proyectos, y el usuario ve feedback inmediato de que se guardó.
...
function cancelarNuevoDecreto() {
  idDecretoSupremoSeleccionado.value = ''
  nuevoDecretoNumero.value = ''
  nuevoDecretoMonto.value = null
}

// --- Componentes / Líneas y Capacidades (embebido, sin API hasta el submit final) ---
...
// --- Ubicaciones (una o más, embebido, sin API hasta el submit final) ---
...
async function guardar() {
  ...
  try {
    ...
    const { data } = await axios.post('/api/proyectos', payload)
    ...
    if (e.response?.status === 422) {
      ...
      error.value = 'No se pudo crear el proyecto. Intenta nuevamente.'
    }
  } finally {
...
onMounted(cargarDecretosSupremos)
</script>

<template>
  <div class="page">

    <p class="page-intro">Complete la información base del proyecto de inversión pública.</p>
      ...
      <div v-show="currentStep === 1" class="row-2col">
        ...
        <div class="card">
          ...
          <div class="card-body grid-3">
            ...
            <!-- CREAR NUEVO DECRETO — tarjeta propia con su botón de guardar -->
            ...
            <!-- DECRETO YA CONFIRMADO / SELECCIONADO — tarjeta de estado -->
...
3.239 Ton/año cortes especiales"
      ...
      <!-- ========================================================
           PASO 2 — Beneficiarios + Ubicación (una o más)
      ========================================================= -->
      ...
      <div class="form-actions">
        ...
        <button type="submit" class="btn-primary" :disabled="guardando">
          ...
          <span v-else>{{ guardando ? 'Guardando...' : 'Guardar proyecto' }}</span>
        </button>
      </div>
